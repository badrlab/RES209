...
class SibylClientUdpBinProtocol(DatagramProtocol):
    ...
    def sendRequest(self, line):
	    ...
	    request=time_binaire+len_binaire+message_binaire
    
	    self.transport.write(request,(self.serverAdress,self.serverPort))
    ...
    def datagramReceived(self, datagram, host):
        ...
        """
	    message=sibyl.protocol.Fonction.decoder_binaire(datagram)
	    print(message)
