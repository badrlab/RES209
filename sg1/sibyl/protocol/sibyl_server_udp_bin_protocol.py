...
class SibylServerUdpBinProtocol(DatagramProtocol):
	...
	message=sibyl.protocol.Fonction.decoder_binaire(line)
	reponse=self.sibylServerProxy.generateResponse(message)
	message=sibyl.protocol.Fonction.coder_binaire(reponse)
