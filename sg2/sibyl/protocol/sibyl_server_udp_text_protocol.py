...
class SibylServerUdpTextProtocol(DatagramProtocol):
    ...
    def datagramReceived(self, datagram, host_port):
        ...
        datagram = ((datagram.split(":"))[1]).split("\r")[0]
        respons = self.sibylServerProxy.generateResponse(datagram)
        respons = (str(time.time()) + ": " + str(respons) + "\r\n")
        self.transport.write(respons.encode('utf-8'), host_port)
